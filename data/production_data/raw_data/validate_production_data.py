### NOTE: validated this with the production data from the apparent consumption dataset - use that one!
# cleaning data to get aggregate construction totals
...
filtered_prod_data = filtered_prod_data[filtered_prod_data['Data Description'] == 'Construction sand and gravel']
print(filtered_prod_data)

# drop the total commodity class since earlier years don't have this class
drop_comm = ['Stone, crushed', 'Sand and gravel, construction']
...
state_level_prod_data.to_csv('production_data/cleaned_data/validated_sand_production_1971_2023-12082025.csv', index=False)
